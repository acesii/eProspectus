...
class SubjectController {
    ...
    def save(Subject subjectInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'subjectInstance.label', default: 'Subject'), subjectInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'subjectInstance.label', default: 'Subject'), params.id])
                redirect action: "index", method: "GET"
            }
